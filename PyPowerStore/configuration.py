...
class Configuration:
    ...
    def get_network_details(self, network_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting network details by ID: '{network_id}'")
    ...
    def get_network_by_name(self, name):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting network details by name: '{name}'")
    ...
    def add_remove_ports(self, network_id, add_port_ids=None, remove_port_ids=None):
        ...
        """
        LOG.info(f"Add/remove IP ports: '{network_id}'")
    ...
    def get_roles(self, filter_dict=None, all_pages=None):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting roles with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_role_details(self, role_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting role details by ID: '{role_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def get_role_by_name(self, name):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting role details by name: '{name}'")
        resp = self.get_roles()
        for role in resp:
            if role["name"] == name:
    ...
    def get_local_users(self, filter_dict=None, all_pages=None):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting local users with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_local_user_details(self, user_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting local user details by user ID: '{user_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def get_local_user_by_name(self, name):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting local user details by name: '{name}'")
    ...
    def delete_local_user(self, user_id):
        ...
        :rtype: None
        """
        LOG.info(f"Deleting local user id: '{user_id}'")
        return self.config_client.request(
            constants.DELETE,
    ...
    def create_local_user(self, create_params):
        ...
        :rtype: None
        """
        LOG.info(f"creating local user name: '{create_params['name']}'")
    ...
    def modify_local_user(self, local_user_id, modify_parameters):
        ...
        :rtype : dict
        """
        LOG.info(f"Modifying local user properties: '{local_user_id}'")
        ...
        if modify_parameters:
            if (
                ...
                LOG.info(f"Modifying passwords: '{payload}'")

            for key, value in modify_parameters.items():
                if value is not None:
                    payload = {}
                    payload[key] = value
                    LOG.info(f"Modifying localuser: '{payload}'")
                    self.config_client.request(
                        constants.PATCH,
                        constants.MODIFY_LOCAL_USER_URL.format(
                            self.server_ip, local_user_id,
    ...
    def get_cluster_details(self, cluster_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting cluster details by ID: '{cluster_id}'")
    ...
    def get_cluster_by_name(self, name):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting cluster details by name: '{name}'")
        querystring = constants.CLUSTER_DETAILS_QUERY
        if helpers.is_foot_hill_or_higher():
            querystring = {
                "select": "id,global_id,name,management_address,"
    ...
    def modify_cluster(self, cluster_id, physical_mtu=None, name=None):
        ...
        :rtype : dict
        """
        LOG.info(f"Modifying cluster properties: '{cluster_id}'")
        payload = {}
    ...
    def get_chap_configs(self, filter_dict=None, all_pages=None):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting CHAP configurations with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_chap_config_details(self, chap_config_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting CHAP configuration details by ID: '{chap_config_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def modify_chap_config(self, chap_config_id, mode):
        ...
        :rtype : dict
        """
        LOG.info(f"Modifying CHAP configuration properties: '{chap_config_id}'")
        payload = {}
        if mode is not None:
            payload["mode"] = mode
        self.config_client.request(
    ...
    def get_service_configs(self, filter_dict=None, all_pages=None):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting service configurations with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_service_config_details(self, service_config_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting service config details by ID: '{service_config_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def modify_service_config(self, service_config_id, is_ssh_enabled=None):
        ...
        :rtype : dict
        """
        LOG.info(f"Modifying service config properties: '{service_config_id}'")
        payload = {}
    ...
    def get_service_users(self, filter_dict=None, all_pages=None):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting service users with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_service_user_details(self, service_user_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting service user details by ID: '{service_user_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def get_service_user_by_name(self, name):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting service user details by name: '{name}'")
        resp = self.config_client.request(
            constants.GET,
            constants.GET_SERVICE_USER_LIST_URL.format(self.server_ip),
            querystring=helpers.prepare_querystring(
    ...
    def modify_service_user(self, service_user_id, password):
        ...
        :rtype : dict
        """
        LOG.info(f"Modifying service user properties: '{service_user_id}'")
        payload = {}
    ...
    def get_ip_port_details(self, ip_port_id):
        ...
        :rtype : dict
        """
        LOG.info(f"Getting IP port details by ID: '{ip_port_id}'")
        return self.config_client.request(
            constants.GET,
    ...
    def get_vcenter_details(self, vcenter_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting vcenter details by ID: '{vcenter_id}'")
    ...
    def modify_vcenter(self, vcenter_id, modify_param_dict):
        ...
        :rtype: dict
        """
        LOG.info(f"Modifying vCenter attributes: '{vcenter_id}'")
        self.config_client.request(
            constants.PATCH,
    ...
    def remove_vcenter(self, vcenter_id, delete_vasa_provider=None):
        ...
        :rtype: None
        """
        LOG.info(f"Removing vcenter: {vcenter_id}.")
        payload = {}
    ...
    def get_appliance_details(self, appliance_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting appliance details by ID: '{appliance_id}'")
    ...
    def get_appliance_by_name(self, appliance_name):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting appliance details by name: '{appliance_name}'")
        querystring = constants.APPLIANCE_DETAILS_QUERY
        if helpers.is_foot_hill_prime_or_higher():
            querystring = constants.APPLIANCE_DETAILS_FHP_QUERY
        elif helpers.is_foot_hill_or_higher():
    ...
    def get_certificate_details(self, certificate_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting certificate details by ID: '{certificate_id}'")
    ...
    def get_security_configs(self, filter_dict=None, all_pages=False):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting security configs with filter: '{filter_dict}'")
        if all_pages:
    ...
    def get_security_config_details(self, security_config_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting security config details by ID: '{security_config_id}'")
    ...
    def get_destination_email_details(self, email_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting email details by ID: '{email_id}'")
    ...
    def get_destination_email_by_address(self, email_address):
        ...
        :rtype: list[dict]
        """
        LOG.info(f"Getting destination email details by address: '{email_address}'")
        return self.config_client.request(
            constants.GET,
            constants.GET_EMAIL_LIST_URL.format(self.server_ip),
            querystring=helpers.prepare_querystring(
    ...
    def delete_destination_email(self, email_id):
        ...
        :rtype: None
        """
        LOG.info(f"Deleting email id: '{email_id}'")
        return self.config_client.request(
            constants.DELETE,
    ...
    def test_destination_email(self, email_id):
        ...
        :rtype: None
        """
        LOG.info(f"Testing email id: '{email_id}'")
        return self.config_client.request(
            constants.POST,
    ...
    def get_smtp_config_details(self, smtp_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting SMTP config details by ID: '{smtp_id}'")
    ...
    def test_smtp_config(self, smtp_id, test_parameters):
        ...
        :rtype: None
        """
        LOG.info(f"Testing smtp id: '{smtp_id}'")
        return self.config_client.request(
            constants.POST,
    ...
    def get_dns_details(self, dns_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting DNS details by ID: '{dns_id}'")
    ...
    def modify_dns_details(self, dns_id, modify_parameters):
        ...
        :rtype : None
        """
        LOG.info(f"Modifying DNS : '{dns_id}' with params '{modify_parameters}'")
    ...
    def get_ntp_details(self, ntp_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting NTP details by ID: '{ntp_id}'")
    ...
    def modify_ntp_details(self, ntp_id, modify_parameters):
        ...
        :rtype : None
        """
        LOG.info(f"Modifying NTP : '{ntp_id}' with params '{modify_parameters}'")
    ...
    def get_remote_support_details(
        ...
        :rtype: dict
        """
        LOG.info(f"Getting remote_support details by ID: '{remote_support_id}'")
        if helpers.is_foot_hill_or_higher():
    ...
    def test_remote_support_config(self, remote_support_id):
        ...
        :rtype : None
        """
        LOG.info(f"Sending a test alert for remote_support : '{(remote_support_id)}'")
        if helpers.is_foot_hill_or_higher():
    ...
    def get_ldap_domain_configuration_details(self, ldap_domain_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting ldap domain details by ID: '{ldap_domain_id}'")
    ...
    def modify_ldap_domain_configuration(self, ldap_domain_id, modify_parameters):
        ...
        :rtype: None
        """
        LOG.info(f"Modifying LDAP domain configuration id: '{ldap_domain_id}'")
    ...
    def delete_ldap_domain_configuration(self, ldap_domain_id):
        ...
        :rtype: None
        """
        LOG.info(f"Deleting LDAP domain configuration id: '{ldap_domain_id}'")
    ...
    def verify_ldap_domain_configuration(self, ldap_domain_id):
        ...
        :rtype: None
        """
        LOG.info(f"Verifying LDAP domain configuration id: '{ldap_domain_id}'")
    ...
    def get_ldap_account_details(self, ldap_account_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting LDAP account details by ID: '{ldap_account_id}'")
    ...
    def get_ldap_account_details_by_name(self, ldap_account_name):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting LDAP Account details by name: '{ldap_account_name}'")
    ...
    def modify_ldap_account_details(self, ldap_account_id, modify_parameters):
        ...
        :rtype: None
        """
        LOG.info(f"Modifying LDAP account id: '{ldap_account_id}'")
    ...
    def delete_ldap_account(self, ldap_account_id):
        ...
        :rtype: None
        """
        LOG.info(f"Deleting LDAP account configuration id: '{ldap_account_id}'")
    ...
    def get_storage_container_details(self, storage_container_id):
        ...
        :rtype: dict
        """
        LOG.info(f"Getting storage container details by ID: '{storage_container_id}'")
    ...
    def modify_storage_container_details(self, storage_container_id, modify_parameters):
        ...
        :rtype: None
        """
        LOG.info(f"Modifying storage containert id: '{storage_container_id}'")
    ...
    def delete_storage_container(self, storage_container_id, delete_parameters):
        ...
        :rtype: None
        """
        LOG.info(f"Deleting storage container with id: '{storage_container_id}'")
