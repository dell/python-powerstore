...
class TestTreeQuota(TestBase):
    ...
    def test_get_tree_quota_with_filter(self):
        ...
        with mock.patch.object(self.provisioning.client,
            ...
            self.provisioning.get_file_tree_quotas(filter_dict=querystring,
                                                   all_pages=True)
    ...
    def test_create_tree_quota(self):
        ...
        quota = self.provisioning.create_tree_quota(
            self.data.fs_id1, path, param)
    ...
    def test_create_tree_quota_with_invalid_param(self):
        ...
        self.assertRaisesRegex(
            ...
            self.data.fs_id1, "/" + self.data.fs_name1, param)
