...
class CertificateData:
    ...
    certificate_list = [{"id": certificate_id1}]
    certificate_details = {
            ...
            "messages": [
                {
                    "code": "0xE0901001001D",
                    "severity": "Error",
                    "message_l10n": "Failed to find specific certificate id \
                        37b76535-612b-456a-a694-1389f17632c from credential store.",
    ...
    certificate_create_response = {"id": certificate_id1}
