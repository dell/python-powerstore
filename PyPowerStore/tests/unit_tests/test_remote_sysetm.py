...
class TestRemoteSystem(TestBase):
    ...
    def test_get_remote_systems(self):
        ...
        self.assertListEqual(remote_system_list, self.remote_system_data.remote_system_list)
    ...
    def test_get_remote_system(self):
        ...
        self.assertEqual(remote_system_details_1, self.remote_system_data.remote_system_details_1)
    ...
    def test_create_remote_system(self):
        remote_system_details_1 = self.protection.create_remote_system(self.remote_system_data.create_remote_sys_dict)
        self.assertEqual(remote_system_details_1, self.remote_system_data.remote_system_details_1)
