...
class TestServiceUser(TestBase):
    ...
    def test_get_service_user_details(self):
        ...
        self.assertEqual(service_user_details,
                         self.data.service_user_details_1)
    ...
    def test_modify_service_user(self):
        ...
        self.assertEqual(service_user_details_1,
                         self.data.service_user_details_1)
    ...
    def test_get_service_user_by_name(self):
        ...
        self.assertListEqual(service_user_list,
                             self.data.service_user_list)
