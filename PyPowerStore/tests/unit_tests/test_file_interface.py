...
class TestFileInterface(TestBase):
    ...
    def test_get_file_interfaces(self):
        ...
        self.assertListEqual(file_interface_list,
                             self.file_interface_data.file_interface_list)
    ...
    def test_get_file_interface_details(self):
        ...
        self.assertEqual(file_interface_detail,
                         self.file_interface_data.file_interface_detail)
    ...
    def test_create_file_interface(self):
        ...
        self.assertEqual(file_interface_id,
                         self.file_interface_data.file_interface_id)
