...
class TestFileInterface(TestBase):
    ...
    def test_get_file_interfaces(self):
        ...
        self.assertListEqual(file_interface_list, self.file_interface_data.file_interface_list)
    ...
    def test_get_file_interface_details(self):
        ...
        self.assertEqual(file_interface_detail, self.file_interface_data.file_interface_detail)
    ...
    def test_modify_file_interface(self):
        param = {"ip_address": "10.10.10.10",
                 "prefix_length": 21,
                 "gateway": "10.10.10.1",
                 "vlan_id": 0,
                 "role": "Production",
                 "is_disabled": False}
        resp = self.file_interface.modify_file_interface(self.file_interface_data.file_interface_id, param)
    ...
    def test_modify_file_interface_with_empty_param(self):
        self.assertRaises(
            ValueError, self.file_interface.modify_file_interface,
            self.file_interface_data.file_interface_id, {})
    ...
    def test_delete_file_interface(self):
        resp = self.file_interface.delete_file_interface(self.file_interface_data.file_interface_id)
        self.assertIsNone(resp)
