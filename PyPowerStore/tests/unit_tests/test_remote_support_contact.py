...
class TestRemoteSupportContact(TestBase):
    ...
    def test_get_remote_support_contact_configs(self):
        ...
        self.assertListEqual(remote_support_contact_list, self.remote_support_contact_data.remote_support_contact_list)
    ...
    def test_get_remote_support_contact_details(self):
        ...
        self.assertEqual(resp, self.remote_support_contact_data.remote_support_contact_details)
