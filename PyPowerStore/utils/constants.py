...
# Volume Query
SELECT_ALL_VOLUME = {
    "select": "id,name,description,type,wwn,appliance_id,"
...
SELECT_ALL_VG = {
    "select": "id,name,description,creation_"
...
SELECT_ALL_HOST_VOLUME_MAPPING = {
    "select": "id, host_id, host_group_id,logical_unit_number",
}

SELECT_ALL_FILESYSTEM = {
...
FHP_NAS_QUERYSTRING = {
    "select": "id,name, description, operational_status,"
...
SELECT_ALL_SMB_SHARE = {
    "select": "id,name,path,description,umask,"
...
SELECT_ALL_USER_QUOTA = {
    "select": "id,tree_quota_id,uid,unix_name,"
...
SELECT_ALL_NFS_EXPORT = {
    "select": "id, name, file_system(id, name, "
    "filesystem_type, nas_server(id, name)), "
...
# Role details
ROLE_DETAILS_QUERY = {"select": "id,name,is_built_in,description"}
...
# CHAP config details
CHAP_CONFIG_DETAILS_QUERY = {"select": "id,mode,mode_l10n"}

# Service config details
SERVICE_CONFIG_DETAILS_QUERY = {"select": "id,appliance_id,is_ssh_enabled"}

# Service user details
SERVICE_USER_DETAILS_QUERY = {"select": "id,name,is_built_in,is_default_password"}
...
# vCenter details
VCENTER_DETAILS_QUERY = {"select": "id,instance_uuid,address,username"}
...
# SMTP details
SMTP_DETAILS_QUERY = {"select": "id,address,port,source_email"}

# DNS details
DNS_DETAILS_QUERY = {"select": "id,addresses"}
# NTP details
NTP_DETAILS_QUERY = {"select": "id,addresses"}
...
REMOTE_SUPPORT_CONTACT_DETAILS_QUERY = {"select": "id,email,first_name,last_name,phone"}
...
ADD_MEMBERS_TO_VOLUME_GROUP_URL = "https://{0}/api/rest/volume_group/{1}/add_members"
...
CREATE_VOLUME_GROUP_SNAPSHOT_URL = "https://{0}/api/rest/volume_group/{1}/snapshot"
...
REPLICATION_SESSION_FAILOVER_URL = (
    "https://{0}/api/rest/replication_session/{1}/failover"
)
REPLICATION_SESSION_REPROTECT_URL = (
    "https://{0}/api/rest/replication_session/{1}/reprotect"
)
...
SEND_ALERT_REMOTE_SUPPORT_URL = (
    "https://{0}/api/rest/remote_support/{1}/send_test_alert"
)
...
GET_REMOTE_SUPPORT_CONTACT_DETAILS_URL = (
    "https://{0}/api/rest/remote_support_contact/{1}"
)
...
GET_STORAGE_CONTAINER_DESTINATION_LIST_URL = (
    "https://{0}/api/rest/storage_container_destination"
)
GET_STORAGE_CONTAINER_DESTINATION_DETAILS_URL = (
    "https://{0}/api/rest/storage_container_destination/{1}"
)
