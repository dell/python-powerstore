...
class FileInterface:
    ...
    def get_file_interface_list(self, filter_dict=None, all_pages=False):
        ...
        :rtype: list of dict
        """
        LOG.info("Getting file interfaces with filter: '%s' and all_pages: %s"
                 % (filter_dict, all_pages))
        querystring = helpers.prepare_querystring(SELECT_ALL_FILE_INTERFACE, filter_dict)
        LOG.info("Querystring: '%s'" % querystring)
        return self.file_interface_client.request(constants.GET,
                                   GET_FILE_INTERFACE_LIST_URL.format
    ...
    def get_file_interface_details(self, file_interface_id):
        ...
        return self.file_interface_client.request(
            constants.GET,
            GET_FILE_INTERFACE_DETAILS_URL.format(self.server_ip,
                                                  file_interface_id),
            payload=None,
            querystring=querystring)
    ...
    def get_file_interface_by_nas_server_id(self, nas_server_id):
        ...
        LOG.info("Getting file interface details by nas server id: '%s'" % nas_server_id)
        return self.file_interface_client.request(
            constants.GET,
