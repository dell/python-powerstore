...
modify_resp = CONN.config_mgmt.modify_storage_container_details(create_resp['id'], modify_dict)
print(modify_resp)
...
storage_container_details = CONN.config_mgmt.get_storage_container_details(storage_container_list[0]['id'])
print(storage_container_details)

# Get storage container details by name
storage_container_details = CONN.config_mgmt.get_storage_container_details_by_name(storage_container_list[0]['name'])
print(storage_container_details)
