...
# Register a new Host
RESP = CONN.provisioning.create_host(name="pr-sdk-host",
                                     os_type="Linux",
...
HOST_DETAILS = CONN.provisioning.get_host_details(
    host_id=RESP['id'])
print(HOST_DETAILS)
...
# Get Host by name
HOST_BY_NAME = CONN.provisioning.get_host_by_name(
    host_name="powerstore_renamed")
print(HOST_BY_NAME)
