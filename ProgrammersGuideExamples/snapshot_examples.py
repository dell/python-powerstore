...
RESP = CONN.protection.get_volume_snapshot_details(
...
RESP = CONN.protection.modify_volume_snapshot(
    snapshot_id=CREATED_VOL_SNAP_ID, name='pr-sdk-snap-modified',
...
RESP = CONN.protection.create_volume_group_snapshot(
    volume_group_id=CREATED_VG_ID, name='pr-sdk-vg-snap',
    description='Snap from SDK'
)
CREATED_VG_SNAP_ID = RESP.get('id')
print(RESP)

# Get volume group snapshots list
RESP = CONN.protection.get_volume_group_snapshots(
    volume_group_id=CREATED_VG_ID
)
print(RESP)

# Get volume group snapshot details
RESP = CONN.protection.get_volume_group_snapshot_details(
...
RESP = CONN.protection.modify_volume_group_snapshot(
    snapshot_id=CREATED_VG_SNAP_ID, name='pr-sdk-vg-snap-modified',
    expiration_timestamp=EXP_TIMESTAMP)
print(RESP)
